...
proto.joinGame = P.coroutine(function* (msg, session, next) {
    ...
    return this.app.controllers.niuniu.joinGameAsync(session.uid).nodeify(next);
});
...
proto.leaveGame = P.coroutine(function* (msg, session, next) {
    ...
    return this.app.controllers.niuniu.leaveGameAsync(session.uid).nodeify(next);
});
...
proto.getBets = P.coroutine(function* (msg, session, next) {
    ...
    return this.app.controllers.niuniu.getBetsAsync(session.uid).nodeify(next);
});
...
proto.betGold = P.coroutine(function* (msg, session, next) {
    ...
    return this.app.controllers.niuniu.downBetAsync(session.uid, Number(msg.gold), Number(msg.betId)).nodeify(next);
});
// 上庄
proto.upToBanker = P.coroutine(function* (msg, session, next) {
    ...
    return this.app.controllers.niuniu.upBankerAsync(session.uid).nodeify(next);
});
...
proto.downBanker = P.coroutine(function* (msg, session, next) {
    ...
    return this.app.controllers.niuniu.downBankerAsync(session.uid).nodeify(next);
});
...
proto.downSeat = P.coroutine(function* (msg, session, next) {
    ...
    return this.app.controllers.niuniu.downSeatAsync(session.uid, Number(msg.seat)).nodeify(next);
});
...
proto.listBanker = P.coroutine(function* (msg, session, next) {
    ...
    return this.app.controllers.niuniu.listBankerAsync(session.uid).nodeify(next);
});
...
proto.getGameRecord = P.coroutine(function* (msg, session, next) {
    ...
    return this.app.controllers.niuniu.getRecordAsync(session.uid).nodeify(next);
});
...
proto.redPack = P.coroutine(function* (msg, session, next) {
    ...
    return this.app.controllers.niuniu.redPackAsync(session.uid, total, count).nodeify(next);
});
...
proto.broadcast = P.coroutine(function* (msg, session, next) {
    ...
    return this.app.controllers.niuniu.broadcastAsync(session.uid, msg).nodeify(next);
});
