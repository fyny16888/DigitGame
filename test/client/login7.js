...
var main = function(){
    ...
    // var gateClient = {host : '192.168.1.196', port : 3010};
    // var connector1 = {host : '192.168.1.196', port : 3101};
    ...
    var playerId = 'my2016@@oFuEswP1YjAz2xm61KK1SxOH5w0gBB';
    ...
    .then(function(){
		// return client1.request('player.playerHandler.role', {sex: '1', nickName: 'xxxxBB'});
    })
    .then(function(){
