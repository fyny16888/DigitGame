...
var main = function(){
    ...
    var gateClient = {host : 'kaixuan-pc', port : 5010};
    var connector1 = {host : 'kaixuan-pc', port : 5100};
    ...
    var playerId = 'my2016@@oFuEswP1YjAz2xm61KK1SxOH5w0gXZZ';
    ...
    .then(function(){
		return client1.request('game.niuniuHandler.joinTable', { tableId: '2500122' });
    })
    .delay(5000)
    .then(function(){
