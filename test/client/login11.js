...
var main = function(){
    ...
    var gateClient = {host : 'kaixuan-pc', port : 3010};
    var connector1 = {host : 'kaixuan-pc', port : 3101};
    ...
    var playerId = 'my2016@@oFuEswP1YjAz2xm61KK1SxOH5w0gSS';
    ...
    .then(function(){
		return client1.request('player.playerHandler.role', {sex: '1', nickName: 'xxxxSS'});
    })
    .then(function(){
    ...
    .delay(1000)
	.then(function(){
		return client1.request('fight.layoutHandler.layout');
    })
    .then(function(){
		return client1.request('player.taskHandler.tasks');
    })
    .then(function(){
		return client1.request('player.taskHandler.receive', { taskId: 10000});
    })
    .then(function(){
