...
var main = function(){
    ...
    var playerId = 'my2016@@oFuEswP1YjAz2xm61KK1SxOH5w0gFF';
    ...
    .then(function(){
		return client1.request('player.playerHandler.role', {sex: '1', nickName: 'xxxxFF'});
    })
    .delay(100)
    .then(function(){
    ...
    .then(function(){
        ...
        // return client1.request('package.packageHandler.test');
