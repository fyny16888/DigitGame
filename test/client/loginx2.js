...
var main = function(){
    ...
    var playerId = 'my2016@@oFuEswP1YjAz2xm61KK1SxOH5w0gX44';
    ...
    .then(function(){
		// return client1.request('player.playerHandler.role', {sex: '1', nickName: 'xxxx44'});
    })
    .then(function(){
    ...
    .then(function(){
        ...
        client1.on('mapEvent', function(msg){
           logger.info('jjjj', msg);
        });
        
        // return client1.request('chat.chatHandler.send', {channel : 2, tid : 'xxxx33', msg : 'hello world ___tr'});
        // return client1.request('fight.fightHandler.fight');
    })
    .then(function(){
