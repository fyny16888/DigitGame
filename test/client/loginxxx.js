...
var main = function(){
    ...
    var gateClient = {host : 'kaixuan-pc', port : 7010};
    var connector1 = {host : 'kaixuan-pc', port : 7100};
    // var gateClient = {host : '211.149.207.220', port : 7010};
    // var connector1 = {host : '211.149.207.220', port : 7100};
    ...
    var playerId = 'my2016@@oFuEswP1YjAz2xm61KK1SxOH5w0gabbcd';
    ...
    .then(function(){
		// return client1.request('player.playerHandler.role', {sex: '1', nickName: 'xxxxYY'});
    })
    .then(function(){
    ...
    .then(function(){
		// return client1.request('game.niuniuHandler.createTable');
